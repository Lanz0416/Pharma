...
var groceryFeaturedItems = [
  GroceryFeaturedItem("First Aid Kit", "assets/images/firstaidkit.png"),
  GroceryFeaturedItem("Med Devices", "assets/images/medicaldevice.png"),
];

class GroceryFeaturedCard extends StatelessWidget {
  const GroceryFeaturedCard(this.groceryFeaturedItem,
      {this.color = const Color.fromARGB(255, 161, 83, 177)});
